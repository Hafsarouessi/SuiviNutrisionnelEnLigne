...
$ret=mysqli_query($con,"SELECT * FROM nutritioniste WHERE nom='$adminusername' and motDePasse='$pass'");
...
<div class="card-header">
    ...
    <h3 class="text-center font-weight-light my-4" style="color: #C71585; ">Nutritioniste Login</h3></div>
                                    <div class="card-body">
...
<button class="btn btn-primary" name="login" type="submit" style="background-color: #C71585">Login</button>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="../../Home.php" style="color: #C71585; ">Back to Home Page</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
