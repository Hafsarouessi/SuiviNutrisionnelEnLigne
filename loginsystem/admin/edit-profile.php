...
{?>
                       ...
                       <h1 class="mt-4" style="color: #C71585; font-weight: bold; text-shadow: 1px 1px 2px rgba(0,0,0,0.3);"><?php echo $result['fname'];?>'s Profile</h1>
                       <hr>  <div class="card mb-4" style=" background-color: rgba(255, 255, 255, 0.6);">
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button  style="   background: #BDB76B;" type="submit" class="btn btn-primary btn-block" name="update">Update</button></td>
